...
# modified by Stephen Elbert and Jesse Holzer, PNNL
# MyJulia2.jl is functionally the same as MyJulia1.jl
...
genFile = ARGS[2]
contFile = ARGS[3]
println("program ",PROGRAM_FILE, " reading from")
println("RAW file: ",fileAdd)
